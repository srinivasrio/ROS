      ...
      >
        ...
        <div className="relative z-10 p-6 md:p-8 flex flex-col justify-between h-full">
          <div>
            ...
            <h3 className="font-heading font-bold text-base md:text-xl mb-2 text-foreground">
              {feature.title}
            </h3>
          ...
          {/* Bottom accent line */}
          <motion.div
            className="mt-4 h-[2px] rounded-full bg-foreground/10 overflow-hidden"
          >
            <motion.div
  ...
  <section id="features" className="py-12 md:py-24">
    <div className="max-w-6xl mx-auto px-4 md:px-6">
      <RevealMotion className="text-center mb-8 md:mb-16">
        <span className="gradient-text-gold text-sm font-bold uppercase tracking-widest">Everything Included</span>
        <h2 className="text-3xl md:text-5xl font-heading font-bold mt-3 gradient-text-hero">
