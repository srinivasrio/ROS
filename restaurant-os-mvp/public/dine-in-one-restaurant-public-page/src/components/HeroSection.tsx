...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32" id="hero">
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-coral/10 rounded-full blur-[150px]" />
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-teal/10 rounded-full blur-[150px]" />
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-purple/8 rounded-full blur-[150px]" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <motion.h1
          initial={{ opacity: 1 }}
          className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-6 gradient-text-coral" style={{ fontFamily: "'Cabinet Grotesk', sans-serif" }}
        >
        ...
        >
          QR ordering, AI food suggestions, live kitchen coordination, and automatic GST billing — all in one platform built for Indian restaurants.
        </motion.p>
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="btn-primary text-sm md:text-lg pulse-glow !py-2 !px-4 md:!py-[0.9rem] md:!px-[2.2rem]"
        ...
        >
          {[
            ...
            <motion.span
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-muted border border-border text-sm font-medium text-muted-foreground"
            >
              <t.icon className="w-4 h-4 text-emerald" />
              {t.text}
            </motion.span>
          ))}
        </motion.div>
