...
import { X as LucideX, Printer as LucidePrinter, Clock as LucideClock, MapPin as LucideMapPin, Receipt as LucideReceipt, ChefHat as LucideChefHat, Utensils as LucideUtensils } from 'lucide-react';
                        ...
                        >
                            ...
                            <div className="p-6 border-b border-gray-100 flex justify-between items-start bg-gray-50/50">
                                <div>
                                    ...
                                    <p className="text-sm text-black flex items-center gap-4">
                                        ...
                                        <span className="flex items-center gap-1"><LucideMapPin size={14} /> Table {order.table_number || order.table_id}</span>
                                    </p>
                                </div>
                            ...
                            <div className="p-6 border-t border-gray-100 bg-gray-50/30">
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <span className="text-sm font-bold text-black">{formatCurrency(order.total_amount)}</span>
                                </div>
                                <div className="flex justify-between items-center mb-4 border-b border-gray-200 pb-4">
                                    <span className="text-sm text-black font-medium">Tax (5%)</span>
                                    <span className="text-sm font-bold text-black">{formatCurrency(order.total_amount * 0.05)}</span>
                                </div>
                                <div className="flex justify-between items-center mb-6">
                                    <span className="text-black font-bold">Total Amount</span>
                                    <span className="text-2xl font-black text-black">{formatCurrency(order.total_amount * 1.05)}</span>
                                </div>
