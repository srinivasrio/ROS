...
export default function BottomNav() {
    ...
    const navItems = [
        { path: '/waiter/dashboard', label: 'Tables', icon: LayoutGrid },
        { path: '/waiter/kitchen', label: 'Kitchen', icon: ChefHat },
        { path: '/waiter/alerts', label: 'Alerts', icon: Bell },
                            ...
                            <div className="flex flex-col items-center justify-center py-2 relative min-h-[60px]">
                                ...
                                <div className="relative z-10 flex flex-col items-center gap-1">
                                    <motion.div
                                        ...
                                        className={`${active ? 'text-orange-600' : 'text-neutral-400 hover:text-neutral-600'}`}
                                    >
                                        <item.icon
                                            size={24}
                                    ...
                                    <span
                                        className={`text-[10px] font-bold tracking-wide transition-colors duration-200 ${active ? 'text-orange-600' : 'text-neutral-400'}`}
                                    >
                                        {item.label}
                                    </span>
                                </div>
