...
import { User as LucideUser, Settings as LucideSettings, History as LucideHistory, HelpCircle as LucideHelpCircle, LogOut as LucideLogOut, ChevronRight as LucideChevronRight, Utensils as LucideUtensils, Wallet as LucideWallet } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col min-h-screen bg-neutral-50/50 pb-32">
            ...
            <header className="flex items-center justify-between px-6 h-14 bg-white/80 backdrop-blur-md sticky top-0 z-40 border-b border-black/5">
                <h2 className="text-lg font-bold text-black tracking-tight">My Profile</h2>
                <button className="p-2 -mr-2 text-black hover:text-black transition-colors">
            ...
            <main className="flex-1 p-5 overflow-y-auto custom-scrollbar">
                ...
                <div className="bg-white p-5 rounded-2xl shadow-[0_2px_8px_-2px_rgba(0,0,0,0.05)] border border-black/5 flex items-center justify-between mb-6 relative overflow-hidden">
                    <div className="flex flex-col relative z-10">
                        <h1 className="text-xl font-bold text-black tracking-tight mb-0.5">Rahul Verma</h1>
                        <p className="text-sm font-medium text-black mb-3">ID: #1234</p>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="inline-flex items-center px-2.5 py-1 bg-neutral-50 text-black rounded-full text-xs font-bold border border-neutral-100">
                                Lunch Shift
                            </div>
                        </div>
                    </div>
                ...
                {/* Stats Grid */}
                <p className="text-xs font-bold text-black uppercase tracking-wider px-2 mb-3">Today's Performance</p>
                <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="bg-white p-4 rounded-2xl border border-black/5 shadow-sm flex flex-col items-center justify-center text-center gap-2">
                        ...
                        <div>
                            <p className="text-2xl font-bold text-black leading-none">24</p>
                            <p className="text-[10px] font-bold text-black uppercase tracking-wide mt-1">Orders Served</p>
                        </div>
                    </div>
                    <div className="bg-white p-4 rounded-2xl border border-black/5 shadow-sm flex flex-col items-center justify-center text-center gap-2">
                        ...
                        <div>
                            <p className="text-2xl font-bold text-black leading-none">₹450</p>
                            <p className="text-[10px] font-bold text-black uppercase tracking-wide mt-1">Tips Earned</p>
                        </div>
                    </div>
                </div>

                {/* Menu Actions */}
                <p className="text-xs font-bold text-black uppercase tracking-wider px-2 mb-3">Account</p>
                <div className="bg-white rounded-2xl border border-black/5 shadow-sm overflow-hidden mb-8">
                    <button className="w-full flex items-center justify-between p-4 bg-white hover:bg-neutral-50 active:bg-neutral-100 transition-colors border-b border-neutral-100 last:border-0 group">
                        <div className="flex items-center gap-3">
                            <div className="size-8 rounded-lg bg-neutral-50 flex items-center justify-center text-black group-hover:text-black group-hover:bg-neutral-100 transition-colors">
                                <LucideHistory size={18} />
                            </div>
                            <span className="text-sm font-semibold text-black">Shift History</span>
                        </div>
                        <LucideChevronRight size={16} className="text-black group-hover:text-black transition-colors" />
                    </button>
                    <button className="w-full flex items-center justify-between p-4 bg-white hover:bg-neutral-50 active:bg-neutral-100 transition-colors group">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-semibold text-black">Help & Support</span>
                        </div>
                        <LucideChevronRight size={16} className="text-black group-hover:text-black transition-colors" />
                    </button>
                </div>
                ...
                <div className="px-2 mb-6">
                    <Link
                        href={`/${restaurantId}/waiter/login`}
                    ...
                    <div className="flex items-center justify-center gap-2 mt-6 opacity-40 grayscale">
                        ...
                        <p className="text-[10px] font-medium text-black">Restaurant OS • v1.0.2</p>
                    </div>
                </div>
